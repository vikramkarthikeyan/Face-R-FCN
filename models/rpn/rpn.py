...
class RPN(nn.Module):
    ...
    def forward(self, base_features, image_metadata, gt_boxes):
        ...
        rois, scores, face_scores  = self.RPN_proposal(scores, bbox_proposals, image_metadata)
        ...
        if self.training:
            ...
            print("labels generated by ATL:",labels.shape)
            print("face probs:", face_scores.shape)
