...
class RPN(nn.Module):
    ...
    def __init__(self, input_channels, anchor_dimensions, stride):
        ...
        self.RPN_proposal = _ProposalLayer(self.feat_stride, self.anchor_dimensions)

        # define anchor target layer
        self.RPN_anchor_target = _AnchorTargetLayer(self.feat_stride, self.anchor_dimensions)
